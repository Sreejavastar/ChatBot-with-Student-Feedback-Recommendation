...
def check_all_messages(message):
    ...
    response(long.R_ADVICE6, ['improve', 'overall', 'structure', 'organization' ], required_words=['improve', 'overall', 'structure'])
    response(long.R_ADVICE7, ['provide', 'suggestions', 'argument'], required_words=['provide', 'suggestions', 'argument'])
    response(long.R_ADVICE8, ['improve', 'transitions', 'between', 'paragraphs'], required_words=['transitions', 'between', 'paragraphs'])
